<script>
	/**
	 * Chart 3: Normalized Throughput vs Concurrent Users (Step Function, Log Scale)
	 * Shows normalized performance accounting for chip count and normalizing factor
	 */
	...
	let {
		...
		width = 400,
		height = 300,
		title = 'Normalized Throughput vs Concurrent Users'
	} = $props();
			...
			<g clip-path="url(#{clipId})">
				...
				{#each data as point, i (i)}
					<circle
						...
						role="img"
						aria-label="Data point at {point.x} users, {point.y} normalized throughput"
